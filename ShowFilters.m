...
% net_model = 'C:\caffe-windows\examples\GoogLeNet\googlenet_deploy_prob.prototxt';
% net_weights = 'C:\caffe-windows\examples\GoogLeNet\thinned_net.caffemodel';
% net_model = 'C:\caffe-windows\models\flower\deploy.prototxt';
% net_weights = 'C:\caffe-windows\models\flower\thinnednet.caffemodel';
net_model = 'C:\caffe-windows\models\bvlc_reference_caffenet\deploy.prototxt';
net_weights = 'C:\caffe-windows\models\bvlc_reference_caffenet\bvlc_alexnet.caffemodel';
% net_model = 'C:\caffe-windows\models\googlenet_bn\inception_bn_deploy.prototxt';
% net_weights = 'C:\caffe-windows\models\googlenet_bn\inception_bn_1200000.caffemodel';
